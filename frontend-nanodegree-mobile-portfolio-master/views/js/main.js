...
var resizePizzas = function(size) {
  ...
  var dx = determineDx(pizzanewsize[0], size);
  var newwidth = (pizzanewsize[0].offsetWidth + dx) + 'px';
  function changePizzaSizes(size) {
    for (var i = 0, len = pizzanewsize.length; i < len; i++) {
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  var iHeight = (window.screen.height/s) * cols;
